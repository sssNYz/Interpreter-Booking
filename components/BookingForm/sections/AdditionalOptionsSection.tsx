...
interface AdditionalOptionsSectionProps {
  ...
  interpreters: Array<{ interpreterId: number | string; interpreterName: string; interpreterSurname: string }>;
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        <Switch id="highPriority" checked={highPriority} onCheckedChange={(checked) => setHighPriority(checked === true)} />
        <Label htmlFor="highPriority" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
          ...
          <Select value={interpreterId} onValueChange={setInterpreterId}>
            ...
            <SelectContent>
              ...
              {interpreters.map((interpreter) => (
                <SelectItem key={interpreter.interpreterId} value={String(interpreter.interpreterId)}>
